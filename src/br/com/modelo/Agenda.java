...
public class Agenda {
	...
	public void marcarData(int n) {
		...
		String dataB = clientes.get(n).getDatahora().getDataAnterior();
		String velhoCliente = dataA + dataB ;
		
		dataA = funcionarios.get(f).getDatahora().getDataAtual();
		dataB = funcionarios.get(f).getDatahora().getDataAnterior();
		...
		d.setDataAnterior(velhoCliente);
		...
		d.setDataAnterior(velhoFuncionario);
	...
	public void editarAgendamento(int n) {
		...
		String velhoCliente = clientes.get(n).getDatahora().getDataAnterior();
		 
		String velhoFuncionario = funcionarios.get(f).getDatahora().getDataAnterior();
	...
	public void cancelarAgendamento(int n) {
		...
		System.out.printf("O SEU AGENDAMENTO DO DIA: ", data);
		...
		novoCliente.setTelefone(clientes.get(n).getTelefone());
		clientes.remove(n); // removendo as informacoes anteriores
		clientes.add(n, novoCliente);//adicionando as informacoes onde o cliente estava na lista de clientes
	...
	public void historicoFuncionario() {
		...
		String dataAnterior = funcionarios.get(f).getDatahora().getDataAnterior();
	...
	public void historicoCliente() {
		...
		String dataAnterior = clientes.get(c).getDatahora().getDataAnterior();
